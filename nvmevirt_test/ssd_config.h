...
//JY_Modified_Start
#define NAND_4KB_READ_LATENCY_LSB (45000) //ns
#define NAND_4KB_READ_LATENCY_MSB (45000) //ns
#define NAND_4KB_READ_LATENCY_CSB (45000) //not used
#define NAND_READ_LATENCY_LSB (45000)
#define NAND_READ_LATENCY_MSB (45000)
#define NAND_READ_LATENCY_CSB (45000) //not used
#define NAND_PROG_LATENCY (1140000) //380us per page, ISSCC22
#define NAND_ERASE_LATENCY (3500000)
//JY_Modified_End

// #define NAND_4KB_READ_LATENCY_LSB (45) //ns
// #define NAND_4KB_READ_LATENCY_MSB (45) //ns
// #define NAND_4KB_READ_LATENCY_CSB (45) //not used
// #define NAND_READ_LATENCY_LSB (45)
// #define NAND_READ_LATENCY_MSB (45)
// #define NAND_READ_LATENCY_CSB (45) //not used
// #define NAND_PROG_LATENCY (1140) //380us per page, ISSCC22
// #define NAND_ERASE_LATENCY (3500)
...
// #define FW_4KB_READ_LATENCY (21)
// #define FW_READ_LATENCY (30)
// #define FW_WBUF_LATENCY0 (4)
// #define FW_WBUF_LATENCY1 (1)
// #define FW_CH_XFER_LATENCY (0)
// #define OP_AREA_PERCENT (0.07)
...
#define BASE_RR_TH 200000
#define ERROR_TH 15000
#define AVG_RR_TH 300000

#elif (PE_MODE == 2)
#define SRT 50000

#define BASE_RR_TH 350000
#define ERROR_TH 25000
#define AVG_RR_TH 500000

#else
#define SRT 70000

#define BASE_RR_TH 500000
#define ERROR_TH 35000
#define AVG_RR_TH 700000
#endif

#define NUM_SS 32
#define REAL_INVALID 0

// #### graph ####
// #define GRT 5000
// #define SRT 20000

// #define MAX_RR_TH 210000
// #define MIN_RR_TH 190000

// #### llama ####
// #define GRT 1000
// #define SRT 50000

// #define MAX_RR_TH 52500
// #define MIN_RR_TH 47500

// #### YCSB ####
// #define GRT 20000
// #define SRT 100000

// #define MAX_RR_TH 1050000
// #define MIN_RR_TH 950000


// static_assert(MAX_RR_TH > MIN_RR_TH);
